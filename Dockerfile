...
RUN     git clone -b develop https://github.com/ampache/ampache.git /var/www
RUN     mv /var/www/rest/.htac* /var/www/rest/.htaccess \
...
RUN     apt-get purge -q -q -y --autoremove wget ca-certificates gnupg composer \
